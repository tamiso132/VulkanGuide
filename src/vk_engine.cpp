...
void VulkanEngine::draw_background(VkCommandBuffer cmd) {
  ...
  vkCmdBindDescriptorSets(cmd, VK_PIPELINE_BIND_POINT_COMPUTE, effect.layout, 0,
...
void VulkanEngine::init_background_pipelines() {
  ...
  if (!vkutil::load_shader_module(
          "/home/tom/projects/c++/vulkan-guide/shaders/spiv/"
          "gradient_color.comp.spv",
  ...
  if (!vkutil::load_shader_module(
          "/home/tom/projects/c++/vulkan-guide/shaders/spiv/sky.comp.spv",
          _device, &skyShader)) {
    fmt::print("Error when building the compute shader \n");
  }
  ...
  _mainDeletionQueue.push_function([&]() {
    vkDestroyPipelineLayout(_device, this->backgroundEffects[0].layout,
                            nullptr);
