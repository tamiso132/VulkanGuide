...
void VulkanEngine::init_default_data() {
  ...
  rectangle = uploadMesh(std::span{Suzanne_idx, Suzanne_idx_count},
                         std::span{Suzanne_vtx, Suzanne_vtx_count});
  ...
  auto full_path =
      std::string(PROJECT_ROOT_PATH) + "/" + "assets/basicmesh.glb";

  testMeshes = loadGltfMeshes(this, full_path).value();
...
void VulkanEngine::init_background_pipelines() {
  ...
  if (!vkutil::load_shader_module("shaders/spiv/gradient_color.comp.spv",
                                  _device, &gradientShader)) {
    fmt::print("Error when building the compute shader \n");
  }

  VkShaderModule skyShader;
  if (!vkutil::load_shader_module("shaders/spiv/sky.comp.spv", _device,
                                  &skyShader)) {
    fmt::print("Error when building the compute shader \n");
  }
...
void VulkanEngine::init_triangle_pipeline() {
  ...
  if (!vkutil::load_shader_module("shaders/spiv/colored_triangle.frag.spv",
  ...
  if (!vkutil::load_shader_module("shaders/spiv/colored_triangle.vert.spv",
...
void VulkanEngine::init_mesh_pipeline() {
  //> mesh_shader
  VkShaderModule triangleFragShader;
  if (!vkutil::load_shader_module("shaders/spiv/tex_image.frag.spv", _device,
                                  &triangleFragShader)) {
  ...
  VkShaderModule triangleVertexShader;
  if (!vkutil::load_shader_module("shaders/spiv/colored_triangle_mesh.vert.spv",
                                  _device, &triangleVertexShader)) {
...
void GLTFMetallic_Roughness::build_pipelines(VulkanEngine *engine) {
  ...
  if (!vkutil::load_shader_module("shaders/spiv/mesh.frag.spv", engine->_device,
                                  &meshFragShader)) {
    fmt::println("Error when building the triangle fragment shader module");
  }

  VkShaderModule meshVertexShader;
  if (!vkutil::load_shader_module("shaders/spiv/mesh.vert.spv", engine->_device,
                                  &meshVertexShader)) {
